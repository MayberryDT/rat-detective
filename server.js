...
// Find safe spawn point (away from other players)
function findSafeSpawnPoint(activePlayers) {
  const safeDistance = 20; // Minimum distance from other players
  ...
  // If no safe point found, return a random spawn point
